...
class StorageSettings(BaseSettings):
    ...
    class S3ConnectionSettings(BaseSettings):
        endpoint_uri: str = "https://s3.storage.selcloud.ru"
        access_key_id: str = "d5f718c09f9142de8848d05a034b0419"
        secret_access_key: str = "e6431a0265dc4383aa975ead90e94771"
        public_storage_uri: str = "https://75886787-5b85-460a-89bd-0a1887f140e5.selstorage.ru"
        model_config = SettingsConfigDict(env_prefix="S3_")

    default_bucket: str = Field(default="mad-soft-bucket")
